  ...
  const modules = [
    {
      id: 'm1',
      number: 1,
      title: '1. Personal Info & SSN/ITIN',
      icon: User,
      ...
      fields: [
        ...
        { label: 'Filing Status', ...valOrNone(m1?.filingStatus) },
    ...
    },
    {
      id: 'm2',
      number: 2,
      title: '2. Spouse & Daycare Expenses',
      icon: Users,
      ...
      fields: [
        ...
        { label: 'Daycare / Preschool Annual Paid', ...valOrNone(m2Daycare, '$') },
      ],
    },
    {
      id: 'm3',
      number: 3,
      title: '3. Substantial Presence & States',
      icon: Globe,
      ...
      fields: [
        { label: 'TY 2025 Days in US', ...valOrNone(m3Days2025, '', ' Days') },
        { label: 'TY 2024 Days in US', ...valOrNone(m3Days2024, '', ' Days') },
        { label: 'TY 2023 Days in US', ...valOrNone(m3Days2023, '', ' Days') },
      ],
    },
    {
      id: 'm4',
      number: 4,
      title: '4. W-2 Wage Statements & Employer',
    ...
    },
    {
      id: 'm6',
      number: 6,
      title: '6. 1099-B Stocks, ESPP & RSUs',
      icon: TrendingUp,
      ...
      fields: [
        ...
        ...(m6Traded ? [
          ...
          { label: 'Estimated Total Capital Gain / (Loss)', ...valOrNone(m6Gains, '$') },
        ] : []),
      ],
    },
    {
      id: 'm7',
      number: 7,
      title: '7. FBAR / FATCA & Indian Income',
      icon: ShieldCheck,
      ...
      fields: [
        { label: 'Indian Bank Balances > $10,000', text: m7Fbar ? 'Yes (FBAR Applicable)' : (m7Filled ? 'No' : 'Not Provided'), isFilled: m7Filled },
        ...(m7Fbar ? [
          { label: 'Indian Bank Name & Branch', ...valOrNone(m7Bank) },
          { label: 'Peak Year Balance (INR)', ...valOrNone(m7Peak, '₹') },
        ] : []),
      ],
    },
    {
      id: 'm8',
      number: 8,
      title: '8. Mortgage 1098, HSA & Deductions',
      icon: Receipt,
      ...
      fields: [
        { label: 'HSA Annual Contribution (Form 8889)', ...valOrNone(m8Hsa, '$') },
        { label: 'Student Loan Interest (1098-E)', ...valOrNone(m8Loan, '$') },
      ],
    },
    {
      id: 'm9',
      number: 9,
      title: '9. Bank Direct Deposit Routing',
      icon: Building2,
